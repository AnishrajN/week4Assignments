...
//		List<String> list = new ArrayList<String>(windowHandles);=====> (no need to create list anol to handle frame)

		//driver.switchTo().window(list.get(0));===> (just handle the frame that's enough)
		...
		creating.sendKeys("Salesforce Automation by Anish raj");
